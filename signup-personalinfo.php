    ...
    <div class="wrapper">
        ...
        <section id="signup">
            <nav class="header-signin">
                ...
                <p>Déjà membre ?<a href="signin.php"><span class="yellow"> Se connecter<span></a></p>
            </nav>
            <div class="wrapper-right">
                ...
                <label for="conditions">
                    <input type="checkbox" name="conditions">J’accepte les Conditions générales d’utilisation
                </label>
            </div>
